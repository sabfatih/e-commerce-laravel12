...
class="bg-white text-gray-800 shadow-sm py-4">
  ...
  {{-- :class="openQuickCart ? 'translate-x-0' : 'translate-x-full'" --}}
  class="fixed top-0 right-0 w-80 z-50 h-dvh rounded-l-sm shadow-xl font-dm transform transition-transform duration-300 bg-white flex flex-col">
    <header class="flex justify-between items-center px-4 py-2 border-b border-black/10">
    ...
    <section class="max-w-full overflow-y-scroll px-3 py-2 grow space-y-4">
      <div>
        ...
        <div class="divide-y-1 divide-black/10">
          <div class="flex h-24 py-2 px-1 gap-x-2">
